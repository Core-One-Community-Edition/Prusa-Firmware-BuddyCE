...
#ifndef THERMAL_PROTECTION_BED_HYSTERESIS_PERCENT
  #define THERMAL_PROTECTION_BED_HYSTERESIS_PERCENT 0 // No target-proportional component; the band stays at THERMAL_PROTECTION_BED_HYSTERESIS
#endif
